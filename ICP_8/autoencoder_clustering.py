...
def read_NewsGroup_data(similarity):    
    categories_3NG = ['comp.graphics', 'rec.sport.baseball', 'talk.politics.guns','rec.motorcycles','soc.religion.christian']
...
stop_learning = 1.1 #--------------------- The stop learning point.
